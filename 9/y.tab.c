...
#line 1 "file1.y" /* yacc.c:337  */

#include<stdio.h>
int flag = 1;

#line 75 "y.tab.c" /* yacc.c:337  */
# ifndef YY_NULLPTR
...
{
      44,    -8,    -8,    80,    80,     7,    -8,    11,    47,    83,
       6,    35,    -8,    -8,     8,    21,    83,    83,    83,    83,
      83,    -7,     0,     5,    19,    83,    60,    -8,    26,    80,
      80,    20,    20,    -8,    -8,    -8,    83,    83,    71,    83,
      71,    83,    66,    -8,    -8,    71,    71,    71,    71,    -8
};
...
{
       0,    35,    36,     0,     9,     0,     2,     0,    23,     0,
       0,     0,     8,     1,     0,     0,    26,    28,    30,    32,
      34,     0,    12,    14,     0,     0,     0,     3,    24,     5,
       7,    25,    27,    29,    31,    33,    20,    16,    11,    18,
      13,    22,     0,     4,     6,    19,    15,    17,    21,    24
};
...
{
      11,    10,    12,     1,     2,    25,    26,    13,     1,     2,
      25,    36,    27,    31,    32,    33,    34,    35,    37,    38,
      40,    29,    42,    39,    14,    15,   -10,    43,    44,    18,
      19,    20,   -10,    45,    46,    30,    47,    41,    48,   -10,
     -10,    28,    16,    17,    18,    19,    20,     1,     2,     3,
      21,    22,    23,    24,    16,    17,    18,    19,    20,     4,
       0,     0,    21,    22,    23,    24,    28,    16,    17,    18,
      19,    20,    49,    16,    17,    18,    19,    20,    16,    17,
      18,    19,    20,     1,     2,     9,     1,     2,    25
};

static const yytype_int8 yycheck[] =
{
       3,     3,     4,     3,     4,     5,     9,     0,     3,     4,
       5,    18,     6,    16,    17,    18,    19,    20,    18,    22,
      23,    13,    25,    18,    13,    14,     0,    29,    30,     9,
      10,    11,     6,    36,    37,    14,    39,    18,    41,    13,
      14,     6,     7,     8,     9,    10,    11,     3,     4,     5,
      15,    16,    17,    18,     7,     8,     9,    10,    11,    15,
      -1,    -1,    15,    16,    17,    18,     6,     7,     8,     9,
...
{
       0,     3,     4,     5,    15,    20,    21,    22,    23,     5,
      22,    23,    22,     0,    13,    14,     7,     8,     9,    10,
      11,    15,    16,    17,    18,     5,    23,     6,     6,    13,
      14,    23,    23,    23,    23,    23,    18,    18,    23,    18,
      23,    18,    23,    22,    22,    23,    23,    23,    23,     6
};
...
#line 16 "file1.y" /* yacc.c:1652  */
    {printf("\nLogical AND recognized."); yyval = ((yyvsp[-3]) && (yyvsp[0])); printf("\n%d", yyval);}
...
#line 18 "file1.y" /* yacc.c:1652  */
    {printf("\nLogical OR recognized."); yyval = ((yyvsp[-3]) || (yyvsp[0])); printf("\n%d", yyval);}
...
#line 20 "file1.y" /* yacc.c:1652  */
    {printf("\nLogical NOT recognized."); yyval = !(yyvsp[0]); printf("\n%d", yyval);}
