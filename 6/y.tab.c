...
{
       0,   256,   257,   258,   259,    40,    41,    43,    45,    47,
      42,   260,    37
};
# endif
...
{
       0,    16,    17,     0,     0,     0,     0,     2,     0,     0,
       0,     1,     6,     9,    13,    11,    15,     3,     5,     8,
       4,     7,    12,    10,    14
};
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 12 "file1.y" /* yacc.c:1652  */
    {printf("\nValid expression. Value of expression: %d\n", yyval);}
#line 1218 "y.tab.c" /* yacc.c:1652  */
    break;

  case 3:
#line 14 "file1.y" /* yacc.c:1652  */
